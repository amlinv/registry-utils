...
public class ConcurrentRegistry<K, V> {
    ...
    private final ConcurrentLinkedDeque<RegistryListener<K, V>>
     ...
     *
     * @see com.amlinv.registry.util.listener.SimpleSynchronousNotificationExecutor
     */
    ...
    /**
     * Retrieve the notification executor used.
     *
     * @return executor of notifications for this registry.
     */
    public NotificationExecutor<K, V> getNotificationExecutor() {
